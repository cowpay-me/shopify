...
<body>
    <main class="container" role="main">
        ...
        <form method="POST" action="{{ route('authenticate') }}">
            ...
            <input id="appkeyz" name="appkeyz" type="text" placeholder="App-Key" class="marketing-input">
            <input id="appsecretz" name="appsecretz" type="text" placeholder="App-Secret" class="marketing-input">

...
return [
    ...
    'webhooks' => [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://shopify.fawrypay.online/webhook/app-uninstalled')
        ],
            [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'refunds/create'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://shopify.fawrypay.online/webhook/refunds-create')
        ],
    ],
    /*
      |--------------------------------------------------------------------------
